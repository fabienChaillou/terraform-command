...
// InitCommand implements Command for "terraform init".
type InitCommand struct{}

func (c *InitCommand) Help() string { return initHelp }

func (c *InitCommand) Validate(req *Request) []ValidationError {
...
func (c *InitCommand) BuildArgs(req *Request) []string {
	args := []string{"init"}
