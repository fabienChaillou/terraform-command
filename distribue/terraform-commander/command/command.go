// Package command defines the validation and argument-building contract for
...
//
// All concrete commands (*InitCommand, *PlanCommand, etc.) satisfy Command.
// Custom commands registered via Registry.Register must also satisfy Command
// (or the more specific type parameter of a Registry[C]).
