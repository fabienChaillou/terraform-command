...
// PlanCommand implements Command for "terraform plan".
type PlanCommand struct{}

func (c *PlanCommand) Help() string { return planHelp }

func (c *PlanCommand) Validate(req *Request) []ValidationError {
...
func (c *PlanCommand) BuildArgs(req *Request) []string {
	args := []string{"plan"}
