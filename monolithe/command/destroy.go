...
// DestroyCommand implements Command for "terraform destroy".
type DestroyCommand struct{}

func (c *DestroyCommand) Help() string { return destroyHelp }

func (c *DestroyCommand) Validate(req *Request) []ValidationError {
...
func (c *DestroyCommand) BuildArgs(req *Request) []string {
	args := []string{"destroy"}
