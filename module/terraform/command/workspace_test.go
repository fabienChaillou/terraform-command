...
func TestWorkspaceValidate_MissingSubcommand(t *testing.T) {
	...
	errs := cmd.Validate(&terraform.Request{Action: "workspace"})
...
func TestWorkspaceValidate_UnknownSubcommand(t *testing.T) {
	...
	for _, sub := range unknowns {
		t.Run(sub, func(t *testing.T) {
			errs := cmd.Validate(&terraform.Request{Action: "workspace", Subcommand: sub})
			assertErrors(t, errs, 1, []string{"subcommand"})
		})
	}
}
...
func TestWorkspaceValidate_New(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:      "missing name",
			req:       &terraform.Request{Action: "workspace", Subcommand: "new", Args: map[string]interface{}{}},
			wantErrs:  1,
			errFields: []string{"name"},
		},
		{
			name:      "blank name",
			req:       &terraform.Request{Action: "workspace", Subcommand: "new", Args: map[string]interface{}{"name": "   "}},
			wantErrs:  1,
			errFields: []string{"name"},
		},
		{
			name:      "name with spaces",
			req:       &terraform.Request{Action: "workspace", Subcommand: "new", Args: map[string]interface{}{"name": "my workspace"}},
			wantErrs:  1,
			errFields: []string{"name"},
		},
		{
			name:      "name with tab",
			req:       &terraform.Request{Action: "workspace", Subcommand: "new", Args: map[string]interface{}{"name": "my\tws"}},
			wantErrs:  1,
			errFields: []string{"name"},
		},
		{
			name:     "valid name only",
			req:      &terraform.Request{Action: "workspace", Subcommand: "new", Args: map[string]interface{}{"name": "staging"}},
			wantErrs: 0,
		},
		{
			name:     "valid name + state path",
			req:      &terraform.Request{Action: "workspace", Subcommand: "new", Args: map[string]interface{}{"name": "staging", "state": "/tmp/tf.tfstate"}},
			wantErrs: 0,
		},
		{
			name:      "state empty string is invalid",
			req:       &terraform.Request{Action: "workspace", Subcommand: "new", Args: map[string]interface{}{"name": "staging", "state": ""}},
			wantErrs:  1,
			errFields: []string{"state"},
		},
		{
			name:      "state non-string is invalid",
			req:       &terraform.Request{Action: "workspace", Subcommand: "new", Args: map[string]interface{}{"name": "staging", "state": 42}},
			wantErrs:  1,
			errFields: []string{"state"},
		},
		{
			name:      "unknown flag",
			req:       &terraform.Request{Action: "workspace", Subcommand: "new", Args: map[string]interface{}{"name": "staging", "force": true}},
			wantErrs:  1,
...
func TestWorkspaceValidate_Select(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:      "missing name",
			req:       &terraform.Request{Action: "workspace", Subcommand: "select", Args: map[string]interface{}{}},
			wantErrs:  1,
			errFields: []string{"name"},
		},
		{
			name:     "valid name",
			req:      &terraform.Request{Action: "workspace", Subcommand: "select", Args: map[string]interface{}{"name": "prod"}},
			wantErrs: 0,
		},
		{
			name:      "unknown flag",
			req:       &terraform.Request{Action: "workspace", Subcommand: "select", Args: map[string]interface{}{"name": "prod", "force": true}},
			wantErrs:  1,
			errFields: []string{"force"},
		},
	}
...
func TestWorkspaceValidate_Delete(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:      "missing name",
			req:       &terraform.Request{Action: "workspace", Subcommand: "delete", Args: map[string]interface{}{}},
			wantErrs:  1,
			errFields: []string{"name"},
		},
		{
			name:     "valid name only",
			req:      &terraform.Request{Action: "workspace", Subcommand: "delete", Args: map[string]interface{}{"name": "old-env"}},
			wantErrs: 0,
		},
		{
			name:     "valid name + force",
			req:      &terraform.Request{Action: "workspace", Subcommand: "delete", Args: map[string]interface{}{"name": "old-env", "force": true}},
			wantErrs: 0,
		},
		{
			name:      "unknown flag",
			req:       &terraform.Request{Action: "workspace", Subcommand: "delete", Args: map[string]interface{}{"name": "old-env", "dry-run": true}},
			wantErrs:  1,
...
func TestWorkspaceBuildArgs_New(t *testing.T) {
	...
	t.Run("name only", func(t *testing.T) {
		req := &terraform.Request{Subcommand: "new", Args: map[string]interface{}{"name": "dev"}}
	...
	t.Run("name + state", func(t *testing.T) {
		req := &terraform.Request{Subcommand: "new", Args: map[string]interface{}{"name": "dev", "state": "/tmp/tf.tfstate"}}
		args := cmd.BuildArgs(req)
...
func TestWorkspaceBuildArgs_Select(t *testing.T) {
	cmd := &WorkspaceCommand{}
	req := &terraform.Request{Subcommand: "select", Args: map[string]interface{}{"name": "prod"}}
	args := cmd.BuildArgs(req)
...
func TestWorkspaceBuildArgs_Delete(t *testing.T) {
	...
	t.Run("without force", func(t *testing.T) {
		req := &terraform.Request{Subcommand: "delete", Args: map[string]interface{}{"name": "old"}}
		args := cmd.BuildArgs(req)
	...
	t.Run("with force", func(t *testing.T) {
		req := &terraform.Request{Subcommand: "delete", Args: map[string]interface{}{"name": "old", "force": true}}
		args := cmd.BuildArgs(req)
		if !containsArg(args, "-force") {
...
func TestWorkspaceBuildArgs_List(t *testing.T) {
	cmd := &WorkspaceCommand{}
	req := &terraform.Request{Subcommand: "list"}
	args := cmd.BuildArgs(req)
...
func TestWorkspaceBuildArgs_Show(t *testing.T) {
	cmd := &WorkspaceCommand{}
	req := &terraform.Request{Subcommand: "show"}
	args := cmd.BuildArgs(req)
