...
// ApplyCommand implements terraform.Command for "terraform apply".
type ApplyCommand struct{}

func (c *ApplyCommand) Help() string { return applyHelp }

func (c *ApplyCommand) Validate(req *terraform.Request) []terraform.ValidationError {
...
func (c *ApplyCommand) BuildArgs(req *terraform.Request) []string {
	args := []string{"apply"}
